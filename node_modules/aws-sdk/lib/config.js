 ...
 * be assigned to the global {AWS.lib} object.
 *
 * @see AWS.config
 *
 ...
 *     AWS.lib.update({region: 'us-west-2'});
 ...
 *     can only be applied to the global `AWS.lib` object and cannot be
...
AWS.Config = AWS.util.inherit({
   ...
   *   this configuration option can only be applied to the global `AWS.lib`
  ...
  /**
   * Loads configuration data from a JSON file into this lib object.
